...
def main():
	...
	pilz_robot.move(Lin(goal=Pose(position=Point(0.3, 0.1, 0.1),
		orientation=from_euler(0.0,180.0*d_r,0.0)),
		planning_group = 'ur3e_suction',
		target_link = 'tool1',
		reference_frame = 'base_link',
		relative=False,
	...
	pilz_robot.move(Lin(goal=Pose(position=Point(0.4, -0.1, 0.1),
		orientation=from_euler(0.0,180.0*d_r,0.0)),
		planning_group = 'ur3e_suction',
		target_link = 'tool1',
		reference_frame = 'base_link',
